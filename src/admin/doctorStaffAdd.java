 ...
 * @author w10
 */
public class doctorStaffAdd extends javax.swing.JFrame {

    /**
     * Creates new form loginDash
     */
    public doctorStaffAdd() {
        initComponents();
    }

    public void addStaff(String fname, String lname, String username, String num, String pass,String type){
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 140, 30));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 370, 100, 30));
        jPanel2.add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 190, 30));
        jPanel2.add(lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 190, 30));
        jPanel2.add(uname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 190, 30));
        jPanel2.add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 190, 30));
        jPanel2.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, 190, 30));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, -1, 30));
        ...
        jPanel2.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 190, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(fname.getText().isEmpty() || lname.getText().isEmpty() || uname.getText().isEmpty() || num.getText().isEmpty()|| pass.getText().isEmpty()){
            ...
            if (!(pass.getText().length()>=8)){
                ...
                addStaff( fname.getText(),lname.getText(),uname.getText(), num.getText(),pass.getText(), (String)type.getSelectedItem());
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorStaffAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorStaffAdd().setVisible(true);
            }
        });
    }
